...
class EISActivation(nn.Module):
   def __init__(self):
       super(EISActivation, self).__init__()
   def forward(self, x):
       return torch.sigmoid(torch.exp(x) - 1)
...
class VoiceFilter(nn.Module):
    def __init__(self, hp):
        ...
        self.conv = nn.Sequential(
            ...
            nn.BatchNorm2d(64), EISActivation(),
            ...
            nn.BatchNorm2d(8), EISActivation(),
        )
